...
add_action( 'in_plugin_update_message-phoenix-media-rename/phoenix-media-rename.php', 'esl_plugin_update_message', 10, 2 );

function esl_plugin_update_message( $plugin_data, $new_data ) {
